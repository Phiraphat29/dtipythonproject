...
print("ใช้ + --------------------------------")
print("ยินดีต้อนรับ "+ stu_id +" "+ stuName + " สู่ SAU")
print("คุณเกิดปี " + str(stu_birth_year) + " แปลว่าคุณอายุ " + str((2023-int(stu_birth_year))) + " ปี")
print("ใช้ method format ---------------------")
print("ยินดีต้อนรับ {0} {1} สู่ SAU ".format(stu_id, stuName)) 
